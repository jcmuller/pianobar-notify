...
This utility is called from L<pianobar|http://github.com/jcmuller/pianobar>.
...
The F<pianobar> version that I'm using also includes the changes found at L<https://github.com/axelson/pianobar>.
