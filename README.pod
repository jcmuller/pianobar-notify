...
If you're not using my Awesome rc.lua, you should probably comment out line 144. Otherwise, you'll get a LUA error about an "attempt to index global 'musicwidget'..."